...
export function ServiceTemplate({
  ...
  const themeStyle: CSSProperties = {
    ...
    ["--site-bg" as any]: secondaryColor ?? "#F8FAFC",
    ["--site-text" as any]: "#111827",
    ["--site-muted" as any]: "rgba(15, 23, 42, 0.7)",
    ["--site-surface" as any]: "#FFFFFF",
    ["--site-border" as any]: "rgba(15, 23, 42, 0.12)",
  ...
  return (
    ...
    >
      <header className="sticky top-0 z-10 border-b border-[color:var(--site-border)] bg-[color:var(--site-bg)]/80 backdrop-blur">
      ...
      <main>
        ...
        <section className="mx-auto w-full max-w-6xl px-6 py-10" id="services">
