/**
 * Stage 3G · Phase B — the production witness, captured once and made immutable.
 *   BASE_URL=https://siroundchat.com npx tsx scripts/harness/stage3g-witness.ts
 *
...
export const WITNESS_PATH = `${EVIDENCE}/site-spec-stage3g/phase-b-witness.json`;
...
const main = async () => {
  ...
  writeFileSync(WITNESS_HASH_PATH, `${sha}  phase-b-witness.json\n`, { flag: "wx" });
...
if (process.argv[1]?.includes("stage3g-witness")) {
