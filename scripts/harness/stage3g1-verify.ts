/**
 * Stage 3G.1 · Phase F — production, after held-out suite #3.
 *   BASE_URL=https://siroundchat.com npx tsx scripts/harness/stage3g1-verify.ts
 *
...
import { readSealedWitness } from "./stage3g1-witness";
...
const main = async () => {
  console.log(`\n════════ Stage 3G.1 · Phase F · production verification ════════`);
  ...
  const path =
    "/Users/kyro/Downloads/next/audit-output/phase-3/evidence/site-spec-stage3g1/phase-f-verification.json";
