/**
 * Stage 3G.1 · Phase D — the production witness, captured once and made immutable.
 *   BASE_URL=https://siroundchat.com npx tsx scripts/harness/stage3g1-witness.ts
 *
...
if (process.argv[1]?.includes("stage3g1-witness")) {
