/**
 * Stage 3G.2 · Phase F — production, after held-out suite #4.
 *   BASE_URL=https://siroundchat.com npx tsx scripts/harness/stage3g2-verify.ts
 *
...
const main = async () => {
  console.log(`\n════════ Stage 3G.2 · Phase F · production verification ════════`);
  ...
  const path =
    "/Users/kyro/Downloads/next/audit-output/phase-3/evidence/site-spec-stage3g2/phase-f-verification.json";
...
if (process.argv[1]?.includes("stage3g2-verify")) {
