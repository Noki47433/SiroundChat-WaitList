/**
 * Stage 3G.2 · Phase D — the production witness, captured once and made immutable.
 *   BASE_URL=https://siroundchat.com npx tsx scripts/harness/stage3g2-witness.ts
 *
 ...
 */
export const WITNESS_PATH = `${EVIDENCE}/site-spec-stage3g2/${process.env.WITNESS_NAME ?? "phase-d-witness"}.json`;
...
if (process.argv[1]?.includes("stage3g2-witness")) {
